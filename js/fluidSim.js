                ...
                for (let i = 0; i < this.size; i++) {
                    ...
                    for (let jj = 0; jj < factor; jj++) {
                        for (let ii = 0; ii < factor; ii++) {
                            // color density
                            color[0] += oldFluidBox.color[0][oldFluidBox.index(i * factor + ii, j * factor + jj)]
                            color[1] += oldFluidBox.color[1][oldFluidBox.index(i * factor + ii, j * factor + jj)]
                            color[2] += oldFluidBox.color[2][oldFluidBox.index(i * factor + ii, j * factor + jj)]
                    ...
                    // set velocity
                    this.velocity[0][index] = Vx
                    this.velocity[1][index] = Vy
                }
            }
        } else {
            // nearest neighbor
